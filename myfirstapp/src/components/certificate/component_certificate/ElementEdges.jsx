    ...
    return(
        <>
        {
            ...
            <>
                ...
                <div  onMouseDown={()=>info.resizeElement(exId,info)}  className="hidden absolute group-hover:block -bottom-[3px] -left-[2px] w-[10px] h-[10px] cursor-nwse-resize  bg-green-500 z-[99999]"></div>
            </>
            :
            <>
                ...
                <div  onMouseDown={()=>info.resizeElement(id,info)}  className="hidden absolute group-hover:block -bottom-[3px] -left-[2px] w-[10px] h-[10px] cursor-nwse-resize  bg-green-500 z-[99999]"></div>

            </>
        
        }
        <div  onMouseDown={()=>info.rotateElement(id,info)}  className="hidden absolute group-hover:block -top-[3px] -left-[2px] w-[10px] h-[10px] cursor-nwse-resize  bg-green-500 z-[99999]"></div>


        <div  onMouseDown={()=>info.moveElement(id,info)}  className="hidden absolute group-hover:block -top-[5px] left-[50%] translate-[-50%,0%] w-[10px] h-[10px] cursor-nwse-resize  bg-green-500 z-[99999]"></div>
        ...
        <div  onMouseDown={()=>info.moveElement(id,info)}  className="hidden absolute group-hover:block -bottom-[5px] left-[50%] translate-[-50%,0%] w-[10px] h-[10px] cursor-nwse-resize  bg-green-500 z-[99999]"></div>
